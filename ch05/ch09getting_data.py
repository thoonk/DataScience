...
# Dictionary처럼 태그이름을 통해 접근
first_paragraph_id = soup.p['id']       # return p1, cf)  raises KeyError if no 'id'
first_paragraph_id2 = soup.p.get('id')  # return p1, ,cf)  returns None if no 'id'
...
# attribute 값이 특정값인 태그만 얻기: class == "important"
